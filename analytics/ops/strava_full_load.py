...
@op
def create_strava_database_full( context: OpExecutionContext, postgres_conn: PostgresqlDatabaseResource ):
...
@op
def create_athlete_table_full( context: OpExecutionContext, postgres_conn: PostgresqlDatabaseResource ):
...
@op
def extract_athlete_data_full( context: OpExecutionContext, access_token ):
...
@op
def load_athlete_data_full(  context: OpExecutionContext, athlete_data, activities_data, postgres_conn: PostgresqlDatabaseResource ):
...
@op
def create_activities_table_full( context: OpExecutionContext, postgres_conn: PostgresqlDatabaseResource, ):
...
@op
def get_access_token_full( context: OpExecutionContext, config: StravaConfig ):
    ...
    return access_token
@op
def get_access_token_2_full( context: OpExecutionContext, config: StravaConfig ):
...
@op
def load_into_database_full(context: OpExecutionContext, activities_data, postgres_conn: PostgresqlDatabaseResource ):
...
@op
def print_op_full(athlete_data, activities_data):
